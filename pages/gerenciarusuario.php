        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <span><a href="index.php?p=cadastrarusuario">Clique aqui</a> para cadastrar um usuário</span>
                </div>
                                ...
                                <?php } else {
                                    ...
                                    while ($usuario = $sql_query->fetch_assoc()) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="index.php?p=editarusuario&id=<?php echo $usuario['id']; ?>">editar</a> | <a href="index.php?p=deletarusuario&id=<?php echo $usuario['id']; ?>">deletar</a></td>
                                        </tr>
                                        <?php
                                    }
                                } ?>
