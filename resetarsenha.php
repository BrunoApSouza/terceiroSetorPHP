...
if(isset($_POST['email'])) {
    ...
    if($result['id']) {
        ...
        enviarEmail($email, "Sua nova senha na plataforma", "
                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        <form method="post" class="md-float-material">
                            <div class="text-center">
                                <img height="60" src="assets/images/logo_preto_salmao.png" alt="logo.png">
                            </div>
                            <div class="auth-box">
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20" style="background-color: #CC7E65;">Enviar minha senha</button>
                                    </div>
                                </div>
